...
class Filter;
using FilterParam = BOOST_NS::variant<int, float, std::string, GfMatrix4f, Filter*, rif_image>;
...
public:
    ...
    rif_image GetInputImage(FilterInputType inputType) const;
    rif_image GetOutput();
    rif_image_filter GetHandle();
