...
#ifndef HDRPR_MOTION_H
#define HDRPR_MOTION_H
...
inline void HdRprDecomposeTransform(
    GfMatrix4d const& transform, GfVec3f& scale, GfQuatf& orient, GfVec3f& translate) {
...
inline void HdRprGetMotion(
    GfMatrix4d const& startTransform, GfMatrix4d const& endTransform,
    ...
    HdRprDecomposeTransform(startTransform, startScale, startRotation, startTranslate);
    HdRprDecomposeTransform(endTransform, endScale, endRotation, endTranslate);
